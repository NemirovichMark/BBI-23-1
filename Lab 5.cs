...
namespace ConsoleApp5
{
    class program
    {
        static void Main()
        {
            #region  5
            Console.WriteLine(" 5:");
            double[,] m1 = new double[4, 6] { { 9, 1, 3, 2, 6, 1 }, { 0, 2, 0, 11, 12, 4 }, { 2, 24, 4, 7, 5, 5 }, { -2, 4, 5, 8, 6, -8 } };
            double[,] m2 = new double[6, 6] { { 1, 8, 0, 7, 3, 0 }, { 9, 4, 0, 3, 9, 6 }, { 7, 3, 11, 5, 2, 1 }, { 0, 32, 0, 2, 0, 0 }, { 0, 10, -3, 0, 6, 0 }, { 9, -1, 2, 13, 6, 0 } };
            int n;
