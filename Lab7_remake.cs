...
class Program
{
    static void Main(string[] args)
    {
        ...
        groups = SortGroupsByAverageScore(groups);
    ...
    static Group[] SortGroupsByAverageScore(Group[] groups)
    {
        return groups.OrderByDescending(g => g.CalculateAverageScore()).ToArray();
    }
}
