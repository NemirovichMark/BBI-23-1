...
namespace laba_4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Enter array B with 7 elements: "); //array B input
            ...
            //        for (int j = 0; j < arrayA.GetLength(1); j++)
            //        {
            //            if (arrayB[indexOfMaxElInCol] > arrayA[indexOfMaxElInCol, indJ])
            //            {
            //                arrayA[indexOfMaxElInCol, indJ] = arrayB[indexOfMaxElInCol];
            //            }
            //        }
            //    }
            //    indJ++; //next column
