...
namespace laba_5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //ArrayTransform(arrayA, nA, mA); //transforming array A

            //ArrayTransform(arrayB, nB, mB); //transforming array B
        ...
        static void ArrayTransform(int[,] matrix, int nn, int mm) //method to transform matrix (task 23)
        {
            int[] tempArray = new int[5]; // 

            for (int i = 0; i < nn; i++) //finding and keeping 5 biggest elements
            {
            ...
            for (int i = 0; i < nn; i++) //transforming matrix 
            {
                for (int j = 0; j < mm; j++)
                {
