...
namespace Lab8
{
    ...
    class Task2 : Task
    {
        ...
        //method to reverse a word letter by letter
    ...
    class Task4 : Task
    {
        ...
        private string CalculateComplexity(string text)
        {
            ...
            return "Complexity:" + words + punctuations;
        }
    ...
    class Task8 : Task
    {
        ...
        static string MakeLineExactly50Symbols(string line, int length)
        {
    ...
    internal class Program
    {
        ...
        {
            //original text
            string textToDoSum = "Hello what's up, how are you, what are you doing";
